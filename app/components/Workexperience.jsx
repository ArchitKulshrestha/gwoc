...
export const Workexperience = ({ icon, description, duration }) => {
  return (
    <div className="flex flex-col items-center justify-start w-full h-full p-4 hover:scale-105 transition-all">
      ...
      <p className="text-center text-base sm:text-lg font-normal text-text-700">
        {description}
      </p>
      <p className="text-center text-sm sm:text-base font-light text-text-600">
        {duration}
      </p>
    </div>
  );
