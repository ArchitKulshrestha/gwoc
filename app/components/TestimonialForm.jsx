...
const TestimonialForm = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-[#cde8fe]/40 to-[#9bd1fd]/50 z-30 backdrop-blur-[8px] hover:scale-[1.01] transition-all duration-300 ease-in-out  shadow-md rounded-xl flex justify-center items-center mt-16 px-4 sm:px-16 h-[23rem]  sm:w-[40%]  w-[99%]">
      {" "}
